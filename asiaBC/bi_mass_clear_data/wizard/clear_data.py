...
class ClearData(models.TransientModel):
    ...
    all_data = fields.Boolean(string="All Data")
    sale_and_transfer = fields.Boolean(string="Sales & All Transfers")
    purchase_and_transfer = fields.Boolean(string="Purchase & All Transfers")
    transfer = fields.Boolean(string="Only Transfers")

    task_timesheet = fields.Boolean(string="Only Tasks & Timesheets")
    project_task_timesheet = fields.Boolean(string="Project, Tasks & Timesheets")
    invoice_payment_journal = fields.Boolean(string="All Invoicing, Payments & Journal Entries")
    journal_entry = fields.Boolean(string="Only Journal Entries")

    customer_vendor = fields.Boolean(string="Customers & Vendors")
    all_accounting_data = fields.Boolean(string="Chart of Accounts & All Accounting Data")
    mrp_order = fields.Boolean(string="Only Manufacturing Orders")
    bom_mrp_order = fields.Boolean(string="BOM & Manufacturing Orders")
